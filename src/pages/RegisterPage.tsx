          ...
          <div className="rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <p className="text-white/70 text-sm">Create your knowledge transformation account</p>
              </div>
              ...
              <Tabs defaultValue="personal" className="w-full">
                ...
                <TabsContent value="organization">
                  <form onSubmit={handleRegister} className="space-y-6">
                    <div className="space-y-2">
                      <Label htmlFor="org-name" className="text-white/90 font-medium">Organization Name</Label>
                      <div className="relative">
                        <Building2 className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/50" />
                        <Input 
                          id="org-name" 
                          value={name} 
                          onChange={(e) => setName(e.target.value)}
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="org-email" className="text-white/90 font-medium">Admin Email</Label>
                      <div className="relative">
                        <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/50" />
                        <Input 
                          id="org-email" 
