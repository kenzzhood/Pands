  ...
  return (
    <div className="min-h-screen space-y-16 pb-16">
      ...
      <div className="text-center max-w-6xl mx-auto mb-16 relative">
        <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-gray-300 rounded-full px-4 py-2 mb-8">
        ...
        <div className="text-left max-w-4xl mx-auto mb-12 bg-white/80 backdrop-blur-sm border border-gray-300 rounded-2xl p-8 shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-300 rounded-xl p-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
                <p className="text-gray-600 text-sm font-mono mb-2">React Three Fiber Component</p>
                <div className="text-xs text-gray-500 space-y-1">
                  ...
                  <p className="mt-2 text-gray-400">// Component code with shader implementation...</p>
                  <p className="text-gray-400">// (Full implementation available in components/ui)</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
          ...
          <Button asChild variant="outline" size="lg" className="backdrop-blur-sm bg-white border-gray-300 text-black hover:bg-gray-100 px-8 py-6 text-lg font-semibold">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h3 className="text-3xl font-bold text-black mb-4">Interactive Globe Component</h3>
          <p className="text-gray-600 text-lg">Experience the integrated component in action</p>
        </div>
        
        <div className="relative h-[500px] mb-12 flex items-center justify-center">
          <div className="relative w-[500px] h-[500px] rounded-3xl bg-white/80 backdrop-blur-sm border border-gray-300 overflow-hidden shadow-2xl">
            <Globe className="top-0" />
            <div className="absolute bottom-6 left-6 right-6 text-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl px-4 py-2 border border-gray-300">
